...
-(void)awakeFromNib
{
    surround = [[NSBundle bundleForClass:[self class]] imageForResource:@"Toggle-Slider"];
    knob     = [[NSBundle bundleForClass:[self class]] imageForResource:@"Toggle-Knob"];
        ...
        while (loop) {
            ...
            switch ([localEvent type]) {
                ...
                case NSEventTypeLeftMouseUp:
                    ...
                    // the rectangle has moved, we need to reset our cursor rectangle
